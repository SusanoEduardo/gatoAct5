function app() {
    ...
    const gato =
    {
        ...
        definirGanador: function () {
            ...
            if(gato.estados[0][0] == null & gato.estados[0][1] == null & gato.estados[0][2] == null &
                gato.estados[1][0] == null & gato.estados[1][1] == null & gato.estados[1][2] == null &
                gato.estados[2][0] == null & gato.estados[2][1] == null & gato.estados[2][2] == null){
                    empate();
                }
